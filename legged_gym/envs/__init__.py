...
from legged_gym.envs.go2.go2_config import GO2Cfg, GO2CfgPPO, GO2CfgCTS, GO2CfgMoECTS, GO2CfgMoENGCTS, GO2CfgMCPCTS, GO2CfgACMoECTS, GO2CfgDualMoECTS, GO2CfgMoETeacher
...
task_registry.register("go2_moe_teacher", Go2Robot, GO2Cfg(), GO2CfgMoETeacher())
